...
- **dm-x44vt69qqri2bl7vwxb8ck7n.xsd** - XML Schema Definition for the data model
- **dm-x44vt69qqri2bl7vwxb8ck7n_shacl.ttl** - SHACL shapes in Turtle format (this file's companion)
...
- **dm-x44vt69qqri2bl7vwxb8ck7n.xml** - Sample XML instance
- **dm-x44vt69qqri2bl7vwxb8ck7n.json** - JSON representation
- **dm-x44vt69qqri2bl7vwxb8ck7n.html** - Human-readable documentation
...
# Load SHACL shapes
shapes_graph = Graph()
shapes_graph.parse("dm-x44vt69qqri2bl7vwxb8ck7n_shacl.ttl", format="turtle")
...
shacl validate --shapes dm-x44vt69qqri2bl7vwxb8ck7n_shacl.ttl --data your_data.ttl
```
...
// Load shapes
Model shapesModel = Rio.parse(new FileInputStream("dm-x44vt69qqri2bl7vwxb8ck7n_shacl.ttl"), "", RDFFormat.TURTLE);
...
const shapes = await factory.dataset().import(
    fs.createReadStream('dm-x44vt69qqri2bl7vwxb8ck7n_shacl.ttl')
)
