...
- **dm-pm5cks82lnrvyna1xbwpfxic.xsd** - XML Schema Definition for the data model
- **dm-pm5cks82lnrvyna1xbwpfxic_shacl.ttl** - SHACL shapes in Turtle format (this file's companion)
...
- **dm-pm5cks82lnrvyna1xbwpfxic.xml** - Sample XML instance
- **dm-pm5cks82lnrvyna1xbwpfxic.json** - JSON representation
- **dm-pm5cks82lnrvyna1xbwpfxic.html** - Human-readable documentation
...
# Load SHACL shapes
shapes_graph = Graph()
shapes_graph.parse("dm-pm5cks82lnrvyna1xbwpfxic_shacl.ttl", format="turtle")
...
shacl validate --shapes dm-pm5cks82lnrvyna1xbwpfxic_shacl.ttl --data your_data.ttl
```
...
// Load shapes
Model shapesModel = Rio.parse(new FileInputStream("dm-pm5cks82lnrvyna1xbwpfxic_shacl.ttl"), "", RDFFormat.TURTLE);
...
const shapes = await factory.dataset().import(
    fs.createReadStream('dm-pm5cks82lnrvyna1xbwpfxic_shacl.ttl')
)
