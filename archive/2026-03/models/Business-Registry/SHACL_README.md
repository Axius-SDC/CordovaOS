...
- **dm-x250838l7oi6l3yavg9twc1i.xsd** - XML Schema Definition for the data model
- **dm-x250838l7oi6l3yavg9twc1i_shacl.ttl** - SHACL shapes in Turtle format (this file's companion)
...
- **dm-x250838l7oi6l3yavg9twc1i.xml** - Sample XML instance
- **dm-x250838l7oi6l3yavg9twc1i.json** - JSON representation
- **dm-x250838l7oi6l3yavg9twc1i.html** - Human-readable documentation
...
# Load SHACL shapes
shapes_graph = Graph()
shapes_graph.parse("dm-x250838l7oi6l3yavg9twc1i_shacl.ttl", format="turtle")
...
shacl validate --shapes dm-x250838l7oi6l3yavg9twc1i_shacl.ttl --data your_data.ttl
```
...
// Load shapes
Model shapesModel = Rio.parse(new FileInputStream("dm-x250838l7oi6l3yavg9twc1i_shacl.ttl"), "", RDFFormat.TURTLE);
...
const shapes = await factory.dataset().import(
    fs.createReadStream('dm-x250838l7oi6l3yavg9twc1i_shacl.ttl')
)
