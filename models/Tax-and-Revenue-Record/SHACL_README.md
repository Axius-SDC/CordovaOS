...
- **dm-vaw4g2kusit5z0kox5mog54g.xsd** - XML Schema Definition for the data model
- **dm-vaw4g2kusit5z0kox5mog54g_shacl.ttl** - SHACL shapes in Turtle format (this file's companion)
...
- **dm-vaw4g2kusit5z0kox5mog54g.xml** - Sample XML instance
- **dm-vaw4g2kusit5z0kox5mog54g.json** - JSON representation
- **dm-vaw4g2kusit5z0kox5mog54g.html** - Human-readable documentation
...
# Load SHACL shapes
shapes_graph = Graph()
shapes_graph.parse("dm-vaw4g2kusit5z0kox5mog54g_shacl.ttl", format="turtle")
...
shacl validate --shapes dm-vaw4g2kusit5z0kox5mog54g_shacl.ttl --data your_data.ttl
```
...
// Load shapes
Model shapesModel = Rio.parse(new FileInputStream("dm-vaw4g2kusit5z0kox5mog54g_shacl.ttl"), "", RDFFormat.TURTLE);
...
const shapes = await factory.dataset().import(
    fs.createReadStream('dm-vaw4g2kusit5z0kox5mog54g_shacl.ttl')
)
