...
- **dm-ulzd6pe8072mwkqf7i313bov.xsd** - XML Schema Definition for the data model
- **dm-ulzd6pe8072mwkqf7i313bov_shacl.ttl** - SHACL shapes in Turtle format (this file's companion)
...
- **dm-ulzd6pe8072mwkqf7i313bov.xml** - Sample XML instance
- **dm-ulzd6pe8072mwkqf7i313bov.json** - JSON representation
- **dm-ulzd6pe8072mwkqf7i313bov.html** - Human-readable documentation
...
# Load SHACL shapes
shapes_graph = Graph()
shapes_graph.parse("dm-ulzd6pe8072mwkqf7i313bov_shacl.ttl", format="turtle")
...
shacl validate --shapes dm-ulzd6pe8072mwkqf7i313bov_shacl.ttl --data your_data.ttl
```
...
// Load shapes
Model shapesModel = Rio.parse(new FileInputStream("dm-ulzd6pe8072mwkqf7i313bov_shacl.ttl"), "", RDFFormat.TURTLE);
...
const shapes = await factory.dataset().import(
    fs.createReadStream('dm-ulzd6pe8072mwkqf7i313bov_shacl.ttl')
)
