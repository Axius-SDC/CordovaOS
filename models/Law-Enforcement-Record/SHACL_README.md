...
- **dm-yh0opq0bnu6y9y56oukg92uf.xsd** - XML Schema Definition for the data model
- **dm-yh0opq0bnu6y9y56oukg92uf_shacl.ttl** - SHACL shapes in Turtle format (this file's companion)
...
- **dm-yh0opq0bnu6y9y56oukg92uf.xml** - Sample XML instance
- **dm-yh0opq0bnu6y9y56oukg92uf.json** - JSON representation
- **dm-yh0opq0bnu6y9y56oukg92uf.html** - Human-readable documentation
...
# Load SHACL shapes
shapes_graph = Graph()
shapes_graph.parse("dm-yh0opq0bnu6y9y56oukg92uf_shacl.ttl", format="turtle")
...
shacl validate --shapes dm-yh0opq0bnu6y9y56oukg92uf_shacl.ttl --data your_data.ttl
```
...
// Load shapes
Model shapesModel = Rio.parse(new FileInputStream("dm-yh0opq0bnu6y9y56oukg92uf_shacl.ttl"), "", RDFFormat.TURTLE);
...
const shapes = await factory.dataset().import(
    fs.createReadStream('dm-yh0opq0bnu6y9y56oukg92uf_shacl.ttl')
)
