...
- **dm-ftluo2nybgxmn7mawttoos20.xsd** - XML Schema Definition for the data model
- **dm-ftluo2nybgxmn7mawttoos20_shacl.ttl** - SHACL shapes in Turtle format (this file's companion)
...
- **dm-ftluo2nybgxmn7mawttoos20.xml** - Sample XML instance
- **dm-ftluo2nybgxmn7mawttoos20.json** - JSON representation
- **dm-ftluo2nybgxmn7mawttoos20.html** - Human-readable documentation
...
# Load SHACL shapes
shapes_graph = Graph()
shapes_graph.parse("dm-ftluo2nybgxmn7mawttoos20_shacl.ttl", format="turtle")
...
shacl validate --shapes dm-ftluo2nybgxmn7mawttoos20_shacl.ttl --data your_data.ttl
```
...
// Load shapes
Model shapesModel = Rio.parse(new FileInputStream("dm-ftluo2nybgxmn7mawttoos20_shacl.ttl"), "", RDFFormat.TURTLE);
...
const shapes = await factory.dataset().import(
    fs.createReadStream('dm-ftluo2nybgxmn7mawttoos20_shacl.ttl')
)
