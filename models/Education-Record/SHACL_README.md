...
- **dm-upq7w1bqbix5v5ss0mu3kq5n.xsd** - XML Schema Definition for the data model
- **dm-upq7w1bqbix5v5ss0mu3kq5n_shacl.ttl** - SHACL shapes in Turtle format (this file's companion)
...
- **dm-upq7w1bqbix5v5ss0mu3kq5n.xml** - Sample XML instance
- **dm-upq7w1bqbix5v5ss0mu3kq5n.json** - JSON representation
- **dm-upq7w1bqbix5v5ss0mu3kq5n.html** - Human-readable documentation
...
# Load SHACL shapes
shapes_graph = Graph()
shapes_graph.parse("dm-upq7w1bqbix5v5ss0mu3kq5n_shacl.ttl", format="turtle")
...
shacl validate --shapes dm-upq7w1bqbix5v5ss0mu3kq5n_shacl.ttl --data your_data.ttl
```
...
// Load shapes
Model shapesModel = Rio.parse(new FileInputStream("dm-upq7w1bqbix5v5ss0mu3kq5n_shacl.ttl"), "", RDFFormat.TURTLE);
...
const shapes = await factory.dataset().import(
    fs.createReadStream('dm-upq7w1bqbix5v5ss0mu3kq5n_shacl.ttl')
)
