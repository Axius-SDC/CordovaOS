"""
Bulk Import and Template Download views for maritime_port_authority.
"""
import tempfile
import logging
...
class BulkImportView(FormView):
    ...
    template_name = 'maritime_port_authority/bulk_import.html'
    ...
    def form_valid(self, form):
        ...
        processor = BulkImportProcessor(
            model_class=MaritimePortAuthorityInstance,
            xsd_path=xsd_path,
            dm_ct_id=MaritimePortAuthorityInstance.DM_CT_ID,
            dm_label=MaritimePortAuthorityInstance.DM_LABEL,
    ...
    def _find_xsd_path(self):
        ...
        ct_id = MaritimePortAuthorityInstance.DM_CT_ID
