...
"""
List View for maritime_port_authority instances.
...
class InstanceListView(ListView):
    """
    List view for MaritimePortAuthority instances.
    """
    model = MaritimePortAuthorityInstance
    template_name = 'maritime_port_authority/instance_list.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['validation_choices'] = MaritimePortAuthorityInstance.VALIDATION_STATUS_CHOICES
        context['rdf_status_choices'] = MaritimePortAuthorityInstance.RDF_SYNC_STATUS_CHOICES
        return context
