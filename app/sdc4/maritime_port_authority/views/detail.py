...
"""
Detail View for maritime_port_authority instances.
...
class InstanceDetailView(DetailView):
    """
    Detail view for a single MaritimePortAuthority instance.
    """
    model = MaritimePortAuthorityInstance
    template_name = 'maritime_port_authority/instance_detail.html'
...
class InstanceDownloadXMLView(View):
    ...
    def get(self, request, pk):
        ...
        try:
            instance = MaritimePortAuthorityInstance.objects.get(pk=pk)
        except MaritimePortAuthorityInstance.DoesNotExist:
