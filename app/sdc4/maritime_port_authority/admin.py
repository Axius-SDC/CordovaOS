"""
Django admin configuration for MaritimePortAuthority.
...
@admin.register(MaritimePortAuthorityInstance)
class MaritimePortAuthorityInstanceAdmin(admin.ModelAdmin):
    """
    Admin interface for MaritimePortAuthority instances.
