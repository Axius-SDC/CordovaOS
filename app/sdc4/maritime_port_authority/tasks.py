"""
Celery tasks for maritime_port_authority.
...
def extract_and_upload_rdf(self, instance_id: int):
    ...
    try:
        # Get instance
        instance = MaritimePortAuthorityInstance.objects.get(pk=instance_id)
...
def cleanup_failed_rdf_syncs():
    ...
    failed_instances = MaritimePortAuthorityInstance.objects.filter(
