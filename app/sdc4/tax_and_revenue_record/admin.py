"""
Django admin configuration for TaxAndRevenueRecord.
...
@admin.register(TaxAndRevenueRecordInstance)
class TaxAndRevenueRecordInstanceAdmin(admin.ModelAdmin):
    """
    Admin interface for TaxAndRevenueRecord instances.
