...
"""
List View for tax_and_revenue_record instances.
...
class InstanceListView(ListView):
    """
    List view for TaxAndRevenueRecord instances.
    """
    model = TaxAndRevenueRecordInstance
    template_name = 'tax_and_revenue_record/instance_list.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['validation_choices'] = TaxAndRevenueRecordInstance.VALIDATION_STATUS_CHOICES
        context['rdf_status_choices'] = TaxAndRevenueRecordInstance.RDF_SYNC_STATUS_CHOICES
        return context
