"""
Bulk Import and Template Download views for tax_and_revenue_record.
"""
import tempfile
import logging
...
class BulkImportView(FormView):
    ...
    template_name = 'tax_and_revenue_record/bulk_import.html'
    ...
    def form_valid(self, form):
        ...
        processor = BulkImportProcessor(
            model_class=TaxAndRevenueRecordInstance,
            xsd_path=xsd_path,
            dm_ct_id=TaxAndRevenueRecordInstance.DM_CT_ID,
            dm_label=TaxAndRevenueRecordInstance.DM_LABEL,
    ...
    def _find_xsd_path(self):
        ...
        ct_id = TaxAndRevenueRecordInstance.DM_CT_ID
