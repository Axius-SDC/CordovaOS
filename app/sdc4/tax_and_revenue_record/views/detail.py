...
"""
Detail View for tax_and_revenue_record instances.
...
class InstanceDetailView(DetailView):
    """
    Detail view for a single TaxAndRevenueRecord instance.
    """
    model = TaxAndRevenueRecordInstance
    template_name = 'tax_and_revenue_record/instance_detail.html'
...
class InstanceDownloadXMLView(View):
    ...
    def get(self, request, pk):
        ...
        try:
            instance = TaxAndRevenueRecordInstance.objects.get(pk=pk)
        except TaxAndRevenueRecordInstance.DoesNotExist:
