"""
Celery tasks for tax_and_revenue_record.
...
def extract_and_upload_rdf(self, instance_id: int):
    ...
    try:
        # Get instance
        instance = TaxAndRevenueRecordInstance.objects.get(pk=instance_id)
...
def cleanup_failed_rdf_syncs():
    ...
    failed_instances = TaxAndRevenueRecordInstance.objects.filter(
