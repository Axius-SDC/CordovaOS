"""
Bulk Import and Template Download views for civil_registry.
"""
import tempfile
import logging
...
class BulkImportView(FormView):
    ...
    template_name = 'civil_registry/bulk_import.html'
    ...
    def form_valid(self, form):
        ...
        processor = BulkImportProcessor(
            model_class=CivilRegistryInstance,
            xsd_path=xsd_path,
            dm_ct_id=CivilRegistryInstance.DM_CT_ID,
            dm_label=CivilRegistryInstance.DM_LABEL,
    ...
    def _find_xsd_path(self):
        ...
        ct_id = CivilRegistryInstance.DM_CT_ID
