...
"""
List View for civil_registry instances.
...
class InstanceListView(ListView):
    """
    List view for CivilRegistry instances.
    """
    model = CivilRegistryInstance
    template_name = 'civil_registry/instance_list.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['validation_choices'] = CivilRegistryInstance.VALIDATION_STATUS_CHOICES
        context['rdf_status_choices'] = CivilRegistryInstance.RDF_SYNC_STATUS_CHOICES
        return context
