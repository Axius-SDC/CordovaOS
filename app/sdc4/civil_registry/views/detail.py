...
"""
Detail View for civil_registry instances.
...
class InstanceDetailView(DetailView):
    """
    Detail view for a single CivilRegistry instance.
    """
    model = CivilRegistryInstance
    template_name = 'civil_registry/instance_detail.html'
...
class InstanceDownloadXMLView(View):
    ...
    def get(self, request, pk):
        ...
        try:
            instance = CivilRegistryInstance.objects.get(pk=pk)
        except CivilRegistryInstance.DoesNotExist:
