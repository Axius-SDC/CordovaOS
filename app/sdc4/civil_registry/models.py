"""
civil_registry - Django models for CivilRegistry DM instances.
...
class CivilRegistryInstance(models.Model):
    """
    SDC4 Data Model instance for CivilRegistry.
    ...
    def get_absolute_url(self):
        return reverse('civil_registry:instance-detail', kwargs={'pk': self.instance_id})
