"""
Django admin configuration for CivilRegistry.
...
@admin.register(CivilRegistryInstance)
class CivilRegistryInstanceAdmin(admin.ModelAdmin):
    """
    Admin interface for CivilRegistry instances.
