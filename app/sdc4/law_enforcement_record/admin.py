"""
Django admin configuration for LawEnforcementRecord.
...
@admin.register(LawEnforcementRecordInstance)
class LawEnforcementRecordInstanceAdmin(admin.ModelAdmin):
    """
    Admin interface for LawEnforcementRecord instances.
