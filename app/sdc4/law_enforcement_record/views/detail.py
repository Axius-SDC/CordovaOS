...
"""
Detail View for law_enforcement_record instances.
...
class InstanceDetailView(DetailView):
    """
    Detail view for a single LawEnforcementRecord instance.
    """
    model = LawEnforcementRecordInstance
    template_name = 'law_enforcement_record/instance_detail.html'
...
class InstanceDownloadXMLView(View):
    ...
    def get(self, request, pk):
        ...
        try:
            instance = LawEnforcementRecordInstance.objects.get(pk=pk)
        except LawEnforcementRecordInstance.DoesNotExist:
