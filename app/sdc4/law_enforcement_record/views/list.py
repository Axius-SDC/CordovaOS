...
"""
List View for law_enforcement_record instances.
...
class InstanceListView(ListView):
    """
    List view for LawEnforcementRecord instances.
    """
    model = LawEnforcementRecordInstance
    template_name = 'law_enforcement_record/instance_list.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['validation_choices'] = LawEnforcementRecordInstance.VALIDATION_STATUS_CHOICES
        context['rdf_status_choices'] = LawEnforcementRecordInstance.RDF_SYNC_STATUS_CHOICES
        return context
