"""
Bulk Import and Template Download views for law_enforcement_record.
"""
import tempfile
import logging
...
class BulkImportView(FormView):
    ...
    template_name = 'law_enforcement_record/bulk_import.html'
    ...
    def form_valid(self, form):
        ...
        processor = BulkImportProcessor(
            model_class=LawEnforcementRecordInstance,
            xsd_path=xsd_path,
            dm_ct_id=LawEnforcementRecordInstance.DM_CT_ID,
            dm_label=LawEnforcementRecordInstance.DM_LABEL,
    ...
    def _find_xsd_path(self):
        ...
        ct_id = LawEnforcementRecordInstance.DM_CT_ID
