"""
Bulk Import and Template Download views for property_registry.
"""
import tempfile
import logging
...
class BulkImportView(FormView):
    ...
    template_name = 'property_registry/bulk_import.html'
    ...
    def form_valid(self, form):
        ...
        processor = BulkImportProcessor(
            model_class=PropertyRegistryInstance,
            xsd_path=xsd_path,
            dm_ct_id=PropertyRegistryInstance.DM_CT_ID,
            dm_label=PropertyRegistryInstance.DM_LABEL,
    ...
    def _find_xsd_path(self):
        ...
        ct_id = PropertyRegistryInstance.DM_CT_ID
