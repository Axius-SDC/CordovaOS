...
"""
List View for property_registry instances.
...
class InstanceListView(ListView):
    """
    List view for PropertyRegistry instances.
    """
    model = PropertyRegistryInstance
    template_name = 'property_registry/instance_list.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['validation_choices'] = PropertyRegistryInstance.VALIDATION_STATUS_CHOICES
        context['rdf_status_choices'] = PropertyRegistryInstance.RDF_SYNC_STATUS_CHOICES
        return context
