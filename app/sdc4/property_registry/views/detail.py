...
"""
Detail View for property_registry instances.
...
class InstanceDetailView(DetailView):
    """
    Detail view for a single PropertyRegistry instance.
    """
    model = PropertyRegistryInstance
    template_name = 'property_registry/instance_detail.html'
...
class InstanceDownloadXMLView(View):
    ...
    def get(self, request, pk):
        ...
        try:
            instance = PropertyRegistryInstance.objects.get(pk=pk)
        except PropertyRegistryInstance.DoesNotExist:
