"""
property_registry - Django models for PropertyRegistry DM instances.
...
class PropertyRegistryInstance(models.Model):
    """
    SDC4 Data Model instance for PropertyRegistry.
    ...
    def get_absolute_url(self):
        return reverse('property_registry:instance-detail', kwargs={'pk': self.instance_id})
