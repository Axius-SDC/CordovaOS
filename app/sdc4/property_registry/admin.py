"""
Django admin configuration for PropertyRegistry.
...
@admin.register(PropertyRegistryInstance)
class PropertyRegistryInstanceAdmin(admin.ModelAdmin):
    """
    Admin interface for PropertyRegistry instances.
