...
"""
List View for education_record instances.
...
class InstanceListView(ListView):
    """
    List view for EducationRecord instances.
    """
    model = EducationRecordInstance
    template_name = 'education_record/instance_list.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['validation_choices'] = EducationRecordInstance.VALIDATION_STATUS_CHOICES
        context['rdf_status_choices'] = EducationRecordInstance.RDF_SYNC_STATUS_CHOICES
        return context
