...
"""
Detail View for education_record instances.
...
class InstanceDetailView(DetailView):
    """
    Detail view for a single EducationRecord instance.
    """
    model = EducationRecordInstance
    template_name = 'education_record/instance_detail.html'
...
class InstanceDownloadXMLView(View):
    ...
    def get(self, request, pk):
        ...
        try:
            instance = EducationRecordInstance.objects.get(pk=pk)
        except EducationRecordInstance.DoesNotExist:
