"""
Django admin configuration for EducationRecord.
...
@admin.register(EducationRecordInstance)
class EducationRecordInstanceAdmin(admin.ModelAdmin):
    """
    Admin interface for EducationRecord instances.
