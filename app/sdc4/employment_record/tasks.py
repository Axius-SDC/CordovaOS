"""
Celery tasks for employment_record.
...
def extract_and_upload_rdf(self, instance_id: int):
    ...
    try:
        # Get instance
        instance = EmploymentRecordInstance.objects.get(pk=instance_id)
...
def cleanup_failed_rdf_syncs():
    ...
    failed_instances = EmploymentRecordInstance.objects.filter(
