"""
Django admin configuration for EmploymentRecord.
...
@admin.register(EmploymentRecordInstance)
class EmploymentRecordInstanceAdmin(admin.ModelAdmin):
    """
    Admin interface for EmploymentRecord instances.
