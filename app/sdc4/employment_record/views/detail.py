...
"""
Detail View for employment_record instances.
...
class InstanceDetailView(DetailView):
    """
    Detail view for a single EmploymentRecord instance.
    """
    model = EmploymentRecordInstance
    template_name = 'employment_record/instance_detail.html'
...
class InstanceDownloadXMLView(View):
    ...
    def get(self, request, pk):
        ...
        try:
            instance = EmploymentRecordInstance.objects.get(pk=pk)
        except EmploymentRecordInstance.DoesNotExist:
