...
"""
List View for employment_record instances.
...
class InstanceListView(ListView):
    """
    List view for EmploymentRecord instances.
    """
    model = EmploymentRecordInstance
    template_name = 'employment_record/instance_list.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['validation_choices'] = EmploymentRecordInstance.VALIDATION_STATUS_CHOICES
        context['rdf_status_choices'] = EmploymentRecordInstance.RDF_SYNC_STATUS_CHOICES
        return context
