"""
Bulk Import and Template Download views for employment_record.
"""
import tempfile
import logging
...
class BulkImportView(FormView):
    ...
    template_name = 'employment_record/bulk_import.html'
    ...
    def form_valid(self, form):
        ...
        processor = BulkImportProcessor(
            model_class=EmploymentRecordInstance,
            xsd_path=xsd_path,
            dm_ct_id=EmploymentRecordInstance.DM_CT_ID,
            dm_label=EmploymentRecordInstance.DM_LABEL,
    ...
    def _find_xsd_path(self):
        ...
        ct_id = EmploymentRecordInstance.DM_CT_ID
