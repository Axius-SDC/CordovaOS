"""
Bulk Import and Template Download views for business_registry.
"""
import tempfile
import logging
...
class BulkImportView(FormView):
    ...
    template_name = 'business_registry/bulk_import.html'
    ...
    def form_valid(self, form):
        ...
        processor = BulkImportProcessor(
            model_class=BusinessRegistryInstance,
            xsd_path=xsd_path,
            dm_ct_id=BusinessRegistryInstance.DM_CT_ID,
            dm_label=BusinessRegistryInstance.DM_LABEL,
    ...
    def _find_xsd_path(self):
        ...
        ct_id = BusinessRegistryInstance.DM_CT_ID
