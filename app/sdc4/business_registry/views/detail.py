...
"""
Detail View for business_registry instances.
...
class InstanceDetailView(DetailView):
    """
    Detail view for a single BusinessRegistry instance.
    """
    model = BusinessRegistryInstance
    template_name = 'business_registry/instance_detail.html'
...
class InstanceDownloadXMLView(View):
    ...
    def get(self, request, pk):
        ...
        try:
            instance = BusinessRegistryInstance.objects.get(pk=pk)
        except BusinessRegistryInstance.DoesNotExist:
