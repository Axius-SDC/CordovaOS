"""
business_registry - Django models for BusinessRegistry DM instances.
...
class BusinessRegistryInstance(models.Model):
    """
    SDC4 Data Model instance for BusinessRegistry.
    ...
    def get_absolute_url(self):
        return reverse('business_registry:instance-detail', kwargs={'pk': self.instance_id})
