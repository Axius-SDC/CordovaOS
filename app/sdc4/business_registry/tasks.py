"""
Celery tasks for business_registry.
...
def extract_and_upload_rdf(self, instance_id: int):
    ...
    try:
        # Get instance
        instance = BusinessRegistryInstance.objects.get(pk=instance_id)
...
def cleanup_failed_rdf_syncs():
    ...
    failed_instances = BusinessRegistryInstance.objects.filter(
