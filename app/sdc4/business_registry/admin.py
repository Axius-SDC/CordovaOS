"""
Django admin configuration for BusinessRegistry.
...
@admin.register(BusinessRegistryInstance)
class BusinessRegistryInstanceAdmin(admin.ModelAdmin):
    """
    Admin interface for BusinessRegistry instances.
