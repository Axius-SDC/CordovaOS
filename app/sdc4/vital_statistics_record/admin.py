"""
Django admin configuration for VitalStatisticsRecord.
...
@admin.register(VitalStatisticsRecordInstance)
class VitalStatisticsRecordInstanceAdmin(admin.ModelAdmin):
    """
    Admin interface for VitalStatisticsRecord instances.
