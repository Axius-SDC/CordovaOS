"""
Celery tasks for vital_statistics_record.
...
def extract_and_upload_rdf(self, instance_id: int):
    ...
    try:
        # Get instance
        instance = VitalStatisticsRecordInstance.objects.get(pk=instance_id)
...
def cleanup_failed_rdf_syncs():
    ...
    failed_instances = VitalStatisticsRecordInstance.objects.filter(
