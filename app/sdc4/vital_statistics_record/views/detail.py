...
"""
Detail View for vital_statistics_record instances.
...
class InstanceDetailView(DetailView):
    """
    Detail view for a single VitalStatisticsRecord instance.
    """
    model = VitalStatisticsRecordInstance
    template_name = 'vital_statistics_record/instance_detail.html'
...
class InstanceDownloadXMLView(View):
    ...
    def get(self, request, pk):
        ...
        try:
            instance = VitalStatisticsRecordInstance.objects.get(pk=pk)
        except VitalStatisticsRecordInstance.DoesNotExist:
