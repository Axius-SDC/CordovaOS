...
"""
List View for vital_statistics_record instances.
...
class InstanceListView(ListView):
    """
    List view for VitalStatisticsRecord instances.
    """
    model = VitalStatisticsRecordInstance
    template_name = 'vital_statistics_record/instance_list.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['validation_choices'] = VitalStatisticsRecordInstance.VALIDATION_STATUS_CHOICES
        context['rdf_status_choices'] = VitalStatisticsRecordInstance.RDF_SYNC_STATUS_CHOICES
        return context
