"""
Bulk Import and Template Download views for vital_statistics_record.
"""
import tempfile
import logging
...
class BulkImportView(FormView):
    ...
    template_name = 'vital_statistics_record/bulk_import.html'
    ...
    def form_valid(self, form):
        ...
        processor = BulkImportProcessor(
            model_class=VitalStatisticsRecordInstance,
            xsd_path=xsd_path,
            dm_ct_id=VitalStatisticsRecordInstance.DM_CT_ID,
            dm_label=VitalStatisticsRecordInstance.DM_LABEL,
    ...
    def _find_xsd_path(self):
        ...
        ct_id = VitalStatisticsRecordInstance.DM_CT_ID
