...
"""
Detail View for healthcare_record instances.
...
class InstanceDetailView(DetailView):
    """
    Detail view for a single HealthcareRecord instance.
    """
    model = HealthcareRecordInstance
    template_name = 'healthcare_record/instance_detail.html'
...
class InstanceDownloadXMLView(View):
    ...
    def get(self, request, pk):
        ...
        try:
            instance = HealthcareRecordInstance.objects.get(pk=pk)
        except HealthcareRecordInstance.DoesNotExist:
