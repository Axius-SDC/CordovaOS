"""
Bulk Import and Template Download views for healthcare_record.
"""
import tempfile
import logging
...
class BulkImportView(FormView):
    ...
    template_name = 'healthcare_record/bulk_import.html'
    ...
    def form_valid(self, form):
        ...
        processor = BulkImportProcessor(
            model_class=HealthcareRecordInstance,
            xsd_path=xsd_path,
            dm_ct_id=HealthcareRecordInstance.DM_CT_ID,
            dm_label=HealthcareRecordInstance.DM_LABEL,
    ...
    def _find_xsd_path(self):
        ...
        ct_id = HealthcareRecordInstance.DM_CT_ID
