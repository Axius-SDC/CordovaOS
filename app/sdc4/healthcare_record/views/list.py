...
"""
List View for healthcare_record instances.
...
class InstanceListView(ListView):
    """
    List view for HealthcareRecord instances.
    """
    model = HealthcareRecordInstance
    template_name = 'healthcare_record/instance_list.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['validation_choices'] = HealthcareRecordInstance.VALIDATION_STATUS_CHOICES
        context['rdf_status_choices'] = HealthcareRecordInstance.RDF_SYNC_STATUS_CHOICES
        return context
