"""
Celery tasks for healthcare_record.
...
def extract_and_upload_rdf(self, instance_id: int):
    ...
    try:
        # Get instance
        instance = HealthcareRecordInstance.objects.get(pk=instance_id)
...
def cleanup_failed_rdf_syncs():
    ...
    failed_instances = HealthcareRecordInstance.objects.filter(
