"""
Django admin configuration for HealthcareRecord.
...
@admin.register(HealthcareRecordInstance)
class HealthcareRecordInstanceAdmin(admin.ModelAdmin):
    """
    Admin interface for HealthcareRecord instances.
